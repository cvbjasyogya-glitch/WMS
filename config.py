...
class Config:
    ...
    REQUEST_MEMORY_LOG_ENABLED = _env_flag("REQUEST_MEMORY_LOG_ENABLED", False)
    REQUEST_MEMORY_LOG_INCLUDE_STATIC = _env_flag("REQUEST_MEMORY_LOG_INCLUDE_STATIC", False)
    REQUEST_MEMORY_LOG_MIN_DELTA_BYTES = _int_env(
        "REQUEST_MEMORY_LOG_MIN_DELTA_BYTES",
        512 * 1024,
    )
    ...
    KIRIMI_API_URL = _first_env_value("KIRIMI_API_URL", "KIRIMI_SEND_MESSAGE_URL")
    ...
    PORTAL_EMAIL_ENROLLMENT_SESSION_MINUTES = _int_env("PORTAL_EMAIL_ENROLLMENT_SESSION_MINUTES", 20)
    PORTAL_PUBLIC_BASE_URL = (os.getenv("PORTAL_PUBLIC_BASE_URL") or "").strip().rstrip("/")
    PORTAL_LOGIN_OTP_DEFAULT_REQUIRED = _env_flag("PORTAL_LOGIN_OTP_DEFAULT_REQUIRED", True)
    PORTAL_LOGIN_OTP_TTL_MINUTES = _int_env("PORTAL_LOGIN_OTP_TTL_MINUTES", 10)
    PORTAL_LOGIN_OTP_SESSION_MINUTES = _int_env("PORTAL_LOGIN_OTP_SESSION_MINUTES", 10)
    PORTAL_LOGIN_OTP_MAX_ATTEMPTS = _int_env("PORTAL_LOGIN_OTP_MAX_ATTEMPTS", 5)
    PORTAL_LOGIN_OTP_DEFAULT_CHANNEL = (
        os.getenv("PORTAL_LOGIN_OTP_DEFAULT_CHANNEL") or "whatsapp"
    ).strip().lower()
    ERP_NOTIFICATION_EMAIL_ENABLED = _env_flag("ERP_NOTIFICATION_EMAIL_ENABLED", True)
