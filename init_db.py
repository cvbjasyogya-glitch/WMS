...
def migrate_schema(cursor):
    ...
    _ensure_column(cursor, "users", "login_otp_required", "INTEGER")
    _ensure_column(cursor, "users", "login_otp_code_hash", "TEXT")
    _ensure_column(cursor, "users", "login_otp_sent_at", "TIMESTAMP")
    _ensure_column(cursor, "users", "login_otp_expires_at", "TIMESTAMP")
    _ensure_column(cursor, "users", "login_otp_attempts", "INTEGER DEFAULT 0")
    _ensure_column(cursor, "users", "login_otp_channel", "TEXT")
